...
def ParseArgs():
	...
	parser.add_argument('--ssl_reg', default=3e-2, type=float, help='weight for contrative learning')
	...
	parser.add_argument("--lambda_reg", type=float, default=0.5, help="The ratio parameter for regularization.")
